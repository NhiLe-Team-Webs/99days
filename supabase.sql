...
create table if not exists public.applicants (
  ...
  gioi_tinh text,
  dia_chi text,
  da_tham_gia_truoc text,
  link_bai_chia_se text,
  muc_tieu text,
  ky_luat_rating integer check (ky_luat_rating between 1 and 5),
  thoi_gian_thuc_day text,
  tan_suat_tap_the_duc text,
  muc_do_van_dong integer check (muc_do_van_dong between 1 and 5),
